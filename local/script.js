...
videoUrls = {
  ...
  clear: "./day.mov",
  cloudy: "./overcast day.mov",
  overcast: "./overcast day.mov",
  snow: "./snow.mp4",
  wind: "./windy day.mov",
  nightClear: "./night clear.mov",
  nightCloudy: "./night clear.mov",
  nightOvercast: "./overcast night.mov",
  nightRain: "./overcast night.mov",
  nightSnow: "./night 2.mov",
  nightWind: "./night 2.mov",
};
...
function processWeatherData(data) {
  ...
  if (data.current.is_day) {
    ...
    if (
      ...
      data.current.condition.text.toLowerCase().includes("cloudy") ||
    ...
    if (
      ...
      $("#video").attr("src", videoUrls.nightCloudy);
        ...
        if (data.current.wind_mph > 10) {
          $("#video").attr("src", videoUrls.nightWind);
          console.log($("#video").attr("src"));
        } else {
          console.log("clear");
          console.log(videoUrls.clear);
